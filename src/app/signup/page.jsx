      ...
      <div className="absolute inset-0 flex justify-center items-center mt-16">
        <div className="bg-edustreet-white px-10 py-10 flex flex-col gap-5">
          ...
          <form action="" className="flex flex-col gap-1">
            ...
            <button type="submit" className="text-xl mt-4 border bg-edustreet-orange p-1 rounded-3xl text-edustreet-white hover:text-black transition-all">Create an account</button>
          </form>
